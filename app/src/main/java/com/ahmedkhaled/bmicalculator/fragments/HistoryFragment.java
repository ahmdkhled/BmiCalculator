...
import com.ahmedkhaled.bmicalculator.HistoryRecyclerAdapter;
import com.ahmedkhaled.bmicalculator.R;
import com.ahmedkhaled.bmicalculator.history;
...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        historyRecycler= (RecyclerView) view.findViewById(R.id.histoyRecycler);
